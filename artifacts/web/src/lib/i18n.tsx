...
const translations: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    "home.hero.eyebrow": "نبض الشارع السوري، لحظة بلحظة",
    "home.hero.title_lead": "كل ما يهمك في",
    "home.hero.title_accent": "سوريا اليوم",
    "home.hero.title": "كل ما يهمك في سوريا اليوم",
    "home.hero.subtitle": "اكتشف أحدث الأخبار، تصفّح الإعلانات المبوّبة، وكن جزءًا من المجتمع السوري المتصل.",
    "home.hero.cta_primary": "تصفّح السوق",
    "home.hero.cta_secondary": "اقرأ الأخبار",
    "home.hero.stat_listings": "إعلان نشط",
    "home.hero.stat_cities": "مدينة ومنطقة",
    "home.hero.stat_ai": "أخبار ملخصة",
    "home.hero.float_sold": "تم بيع شقة",
    "home.hero.float_where": "في دمشق، المزة",
    "home.latest_news": "أخبار تهمك",
    "home.latest_news.subtitle": "ملخصات ذكية لأهم الأحداث اليوم",
    "home.recent_listings": "أحدث الإعلانات",
    "home.categories": "اكتشف الأقسام",
    "home.categories.subtitle": "اعثر على ما تحتاجه — من الأثاث إلى الخدمات.",
    "home.load_more": "تحميل المزيد",
    ...
    "news.search_placeholder": "ابحث في الأخبار…",
    "news.filter_source": "المصدر",
    "news.all_sources": "كل المصادر",
    "news.no_results": "لا توجد نتائج مطابقة. جرّب كلمات مختلفة.",
    "news.clear_filters": "مسح الفلاتر",
    "news.results_count": "{{count}} مقالة",
    "news.results_count_one": "مقالة واحدة",
    "news.tag_active": "وسم: #{{tag}}",
    "news.clear_tag": "مسح الوسم",
    ...
    "post.images": "الصور",
    "post.section.about": "عن الإعلان",
    "post.section.price_location": "السعر والموقع",
    "post.section.photos": "الصور",
    "post.required_note": "* الحقول المطلوبة",
    "post.optional_auto_translate": "اختياري — سيتم الترجمة تلقائياً إذا تُرك فارغاً",
    "post.photos.drag_drop": "اسحب الصور أو انقر للإضافة",
    "post.photos.counter": "{{count}}/5 صور",
    "post.photos.max_reached": "لقد وصلت إلى الحد الأقصى (5 صور)",
    "post.photos.uploading": "جاري رفع الصور...",
    "post.photos.hint": "أضف صوراً واضحة لزيادة فرص بيع العنصر",
    "post.city.placeholder": "اختر المدينة",
    ...
    "footer.tagline": "منصتك اليومية الشاملة لكل ما يهمك في سوريا. بيع، اشترِ، واقرأ أهم الأخبار في مكان واحد.",
    "footer.product": "المنتج",
    "footer.community": "الشركة",
    "footer.about": "عن LivingSyria",
    "footer.contact": "اتصل بنا",
    "footer.privacy": "سياسة الخصوصية",
    "footer.terms": "شروط الاستخدام",
    "footer.made_with": "صُنع بحب لسوريا",
  ...
  en: {
    ...
    "home.hero.eyebrow": "The pulse of the Syrian street, moment by moment",
    "home.hero.title_lead": "Everything that matters in",
    "home.hero.title_accent": "Syria today",
    "home.hero.title": "Everything that matters in Syria today",
    "home.hero.subtitle": "Discover the latest news, browse the classifieds, and be part of the connected Syrian community.",
    "home.hero.cta_primary": "Browse the market",
    "home.hero.cta_secondary": "Read the news",
    "home.hero.stat_listings": "Active listings",
    "home.hero.stat_cities": "Cities & regions",
    "home.hero.stat_ai": "AI-summarized news",
    "home.hero.float_sold": "Apartment sold",
    "home.hero.float_where": "in Damascus, Mezzeh",
    "home.latest_news": "News for you",
    "home.latest_news.subtitle": "Smart summaries of today's top stories",
    "home.recent_listings": "Latest listings",
    ...
    "news.search_placeholder": "Search news…",
    "news.filter_source": "Source",
    "news.all_sources": "All sources",
    "news.no_results": "No matching articles. Try different keywords.",
    "news.clear_filters": "Clear filters",
    "news.results_count": "{{count}} articles found",
    "news.results_count_one": "1 article found",
    "news.tag_active": "Tag: #{{tag}}",
    "news.clear_tag": "Clear tag",
    ...
    "post.images": "Images",
    "post.section.about": "About the listing",
    "post.section.price_location": "Price & Location",
    "post.section.photos": "Photos",
    "post.required_note": "* Required fields",
    "post.optional_auto_translate": "Optional — auto-translated if left blank",
    "post.photos.drag_drop": "Drag photos here or click to add",
    "post.photos.counter": "{{count}}/5 photos",
    "post.photos.max_reached": "You've reached the maximum (5 photos)",
    "post.photos.uploading": "Uploading photos...",
    "post.photos.hint": "Add clear images to increase your chances of selling",
    "post.city.placeholder": "Select city",
    ...
    "footer.tagline": "Your daily one-stop platform for everything that matters in Syria. Buy, sell, and read the top news — all in one place.",
    "footer.product": "Product",
    "footer.community": "Company",
    "footer.about": "About LivingSyria",
    "footer.contact": "Contact us",
    "footer.privacy": "Privacy policy",
    "footer.terms": "Terms of use",
    "footer.made_with": "Made with love for Syria",
...
export { formatCurrency, formatDate, formatRelative } from "@/lib/format";

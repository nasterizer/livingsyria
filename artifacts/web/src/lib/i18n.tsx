...
const translations: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    "settings.profile.name_placeholder": "أدخل اسمك",
    "settings.profile.save": "حفظ الاسم",
    "settings.profile.success": "تم تحديث الاسم",
    ...
    "settings.security.success": "تم تغيير كلمة المرور",
    "settings.security.mismatch": "كلمات المرور غير متطابقة",
    "settings.security.min_length": "كلمة المرور يجب أن تكون 8 أحرف على الأقل",
    ...
    "auth.reset_password.submit": "تعيين كلمة المرور",
    "auth.reset_password.success": "تم تعيين كلمة المرور. سيتم توجيهك لتسجيل الدخول.",
    "auth.reset_password.invalid": "رابط الاسترداد غير صالح أو منتهي الصلاحية",
    "auth.reset_password.mismatch": "كلمات المرور غير متطابقة",
  },
  en: {
    "nav.home": "Home",
    "nav.news": "News",
    ...
    "settings.profile.name_placeholder": "Enter your name",
    "settings.profile.save": "Save name",
    "settings.profile.success": "Name updated",
    ...
    "settings.security.mismatch": "Passwords don't match",
    "settings.security.min_length": "Password must be at least 8 characters",
    ...
    "auth.reset_password.success": "Password set. Redirecting to sign in…",
    "auth.reset_password.invalid": "Reset link is invalid or has expired",
    "auth.reset_password.mismatch": "Passwords don't match",
  },
};
